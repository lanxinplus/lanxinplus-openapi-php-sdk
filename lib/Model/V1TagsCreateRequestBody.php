...
/**
 * V1TagsCreateRequestBody Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class V1TagsCreateRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1TagsCreateRequestBody';
    ...
    {
        $this->container['tagGroupId'] = $data['tagGroupId'] ?? null;
    ...
    {
        return $this->container['tagGroupId'];
    }

    /**
     * Sets tagGroupId
     *
     * @param string|null $tagGroupId tagGroupId
     *
     * @return self
     */
    public function setTagGroupId($tagGroupId)
    {
        $this->container['tagGroupId'] = $tagGroupId;
