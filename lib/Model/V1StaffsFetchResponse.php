...
/**
 * V1StaffsFetchResponse Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class V1StaffsFetchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1StaffsFetchResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\LanXinPlusOpenAPI\Model\V1StaffsFetchData',
        'errCode' => 'int',
        'errMsg' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \LanXinPlusOpenAPI\Model\V1StaffsFetchData|null
     */
     ...
     * Sets data
     *
     * @param \LanXinPlusOpenAPI\Model\V1StaffsFetchData|null $data data
     *
     * @return self
     */
