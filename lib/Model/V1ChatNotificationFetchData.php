...
/**
 * V1ChatNotificationFetchData Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class V1ChatNotificationFetchData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1ChatNotificationFetchData';
     ...
     * Sets noDisturb
     *
     * @param string|null $noDisturb 免打扰标识
     *
     * @return self
     */
