...
/**
 * V1OrgFetchData Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class V1OrgFetchData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1OrgFetchData';
     ...
     * Sets iconUrl
     *
     * @param string|null $iconUrl logo资源ID
     *
     * @return self
     */
