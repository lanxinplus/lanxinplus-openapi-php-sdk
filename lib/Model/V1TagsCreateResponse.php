...
/**
 * V1TagsCreateResponse Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class V1TagsCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1TagsCreateResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\LanXinPlusOpenAPI\Model\V1TagsCreateData',
        'errCode' => 'int',
        'errMsg' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \LanXinPlusOpenAPI\Model\V1TagsCreateData|null
     */
     ...
     * Sets data
     *
     * @param \LanXinPlusOpenAPI\Model\V1TagsCreateData|null $data data
     *
     * @return self
     */
