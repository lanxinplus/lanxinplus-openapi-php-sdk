...
/**
 * V1OrgRoleCreateRequestBody Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class V1OrgRoleCreateRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1OrgRoleCreateRequestBody';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['roleName'] = $data['roleName'] ?? null;
    }
     ...
     * Sets creator
     *
     * @param string|null $creator 角色创建者
     *
     * @return self
     */
     ...
     * Sets roleName
     *
     * @param string|null $roleName 角色名称（名称需要组织内唯一，不可重复，建议使用：应用开发商名称+应用名称+角色名称）
     *
     * @return self
     */
