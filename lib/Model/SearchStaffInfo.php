...
/**
 * SearchStaffInfo Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class SearchStaffInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchStaffInfo';
     ...
     * Sets email
     *
     * @param string|null $email 员工的email
     *
     * @return self
     */
     ...
     * Sets mobile
     *
     * @param string|null $mobile 员工的手机号
     *
     * @return self
     */
     ...
     * Sets staffId
     *
     * @param string|null $staffId 员工的open id
     *
     * @return self
     */
