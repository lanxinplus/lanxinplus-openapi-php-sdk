...
/**
 * AncestorDepartment Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class AncestorDepartment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AncestorDepartment';
     ...
     * Sets departmentId
     *
     * @param string|null $departmentId 人员所在的分支id
     *
     * @return self
     */
     ...
     * Sets externalId
     *
     * @param string|null $externalId 部门数据源ID
     *
     * @return self
     */
