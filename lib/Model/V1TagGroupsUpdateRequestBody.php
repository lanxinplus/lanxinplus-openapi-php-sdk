...
/**
 * V1TagGroupsUpdateRequestBody Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class V1TagGroupsUpdateRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1TagGroupsUpdateRequestBody';
     ...
     * Sets tagGroupName
     *
     * @param string|null $tagGroupName 标签组的名字
     *
     * @return self
     */
