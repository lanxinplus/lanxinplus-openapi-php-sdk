...
/**
 * V1OrgFetchResponse Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class V1OrgFetchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1OrgFetchResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\LanXinPlusOpenAPI\Model\V1OrgFetchData',
        'errCode' => 'int',
        'errMsg' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \LanXinPlusOpenAPI\Model\V1OrgFetchData|null
     */
     ...
     * Sets data
     *
     * @param \LanXinPlusOpenAPI\Model\V1OrgFetchData|null $data data
     *
     * @return self
     */
