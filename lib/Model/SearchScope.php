 ...
 */
class SearchScope implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchScope';
    ...
    {
        $this->container['orgIds'] = $data['orgIds'] ?? null;
        $this->container['sectorIds'] = $data['sectorIds'] ?? null;
    }
     ...
     * Sets sectorIds
     *
     * @param string[]|null $sectorIds 分支/部门ID
     *
     * @return self
     */
