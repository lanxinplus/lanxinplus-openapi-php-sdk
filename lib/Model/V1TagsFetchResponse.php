...
/**
 * V1TagsFetchResponse Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class V1TagsFetchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1TagsFetchResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\LanXinPlusOpenAPI\Model\V1TagsFetchData',
        'errCode' => 'int',
        'errMsg' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \LanXinPlusOpenAPI\Model\V1TagsFetchData|null
     */
     ...
     * Sets data
     *
     * @param \LanXinPlusOpenAPI\Model\V1TagsFetchData|null $data data
     *
     * @return self
     */
