...
/**
 * V1TagGroupsFetchRequestBody Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class V1TagGroupsFetchRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1TagGroupsFetchRequestBody';
     ...
     * Sets categoryList
     *
     * @param int[]|null $categoryList 标签组分类。1：人员标签，2：分支标签
     *
     * @return self
     */
     ...
     * Sets tagGroupType
     *
     * @param string|null $tagGroupType 标签组类型索引
     *
     * @return self
     */
