...
/**
 * V1StaffsCreateResponse Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class V1StaffsCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1StaffsCreateResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\LanXinPlusOpenAPI\Model\V1StaffsCreateData',
        'errCode' => 'int',
        'errMsg' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \LanXinPlusOpenAPI\Model\V1StaffsCreateData|null
     */
     ...
     * Sets data
     *
     * @param \LanXinPlusOpenAPI\Model\V1StaffsCreateData|null $data data
     *
     * @return self
     */
