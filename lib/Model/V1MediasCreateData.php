...
/**
 * V1MediasCreateData Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class V1MediasCreateData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1MediasCreateData';
     ...
     * Sets createdTime
     *
     * @param string|null $createdTime 文件创建时间戳，单位微秒
     *
     * @return self
     */
     ...
     * Sets mediaId
     *
     * @param string|null $mediaId 文件ID
     *
     * @return self
     */
