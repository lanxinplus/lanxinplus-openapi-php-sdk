...
/**
 * V2StaffsIdMappingFetchData Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class V2StaffsIdMappingFetchData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V2StaffsIdMappingFetchData';
     ...
     * Sets staffId
     *
     * @param string|null $staffId staffId
     *
     * @return self
     */
