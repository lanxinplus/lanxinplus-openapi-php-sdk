...
/**
 * AppRoamingOrgList Class Doc Comment
 *
 * @category Class
 * @package  LanXinPlusOpenAPI
 * @author   LanXin+ team
 ...
 */
class AppRoamingOrgList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppRoamingOrgList';
     ...
     * Sets state
     *
     * @param int|null $state 应用对接组织状态，0-正常， 1- 已删除
     *
     * @return self
     */
