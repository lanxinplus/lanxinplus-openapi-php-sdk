...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://open.lanxin.cn/open/apigw';

    /**
     * User agent of the HTTP request, set to "Lanxin/{version}/PHP" by default
     *
     * @var string
     */
    protected $userAgent = 'Lanxin/1.0.0/PHP';
    ...
    {
        $report  = 'PHP SDK (LanXinPlusOpenAPI) Debug Report:' . PHP_EOL;
